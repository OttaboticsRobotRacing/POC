...
public class DriveEncoderCurveSimpleReverseLeft extends Command {
	SimPID drivePIDLeft;
	...
	public DriveEncoderCurveSimpleReverseLeft(double driveTarget, double drivePower, double gyroMax, double driveHeading1, double driveHeading2, double driveHeading3, double driveHeading4, double curvePoint1, double curvePoint2, double curvePoint3) {
    ...
    protected void execute() {
    	...
    	Robot.drivetrain.driveStraightReverseLeft(RobotMap.driveTalonLeft1.getPosition(), RobotMap.driveTalonRight1.getPosition(), reverseAngle, drivePIDLeft, drivePIDRight, steeringPID);	
    }
