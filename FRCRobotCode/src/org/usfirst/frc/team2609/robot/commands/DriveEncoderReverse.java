...
public class DriveEncoderReverse extends Command {
	SimPID drivePIDLeft;
	...
	public DriveEncoderReverse(double driveTarget, double drivePower, double driveHeading) {
    ...
    protected void execute() {
    	...
    	Robot.drivetrain.driveStraightReverseRight(RobotMap.driveTalonLeft1.getPosition(), RobotMap.driveTalonRight1.getPosition(), gyroYaw, drivePIDLeft, drivePIDRight, steeringPID);	
    }
