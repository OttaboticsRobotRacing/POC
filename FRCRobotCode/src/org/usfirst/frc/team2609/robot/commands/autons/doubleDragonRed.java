...
import org.usfirst.frc.team2609.robot.commands.DriveEncoderCurveSimpleReverseLeft;
import org.usfirst.frc.team2609.robot.commands.DriveEncoderCurveSimpleReverseRight;
import org.usfirst.frc.team2609.robot.commands.DriveEncoderCurveSimpleRight;
...
public class doubleDragonRed extends CommandGroup {

	protected void initialize(){
	}
	
    public doubleDragonRed() {
    	double point1 = 15;
    	double point2 = 130;
    	double point3 = 130;
    	double totalArc = 130;
...
//    	addSequential(new autoClawClose());
    	...
    	addSequential(new DriveEncoderCurveSimpleRight(totalArc, 0.6, 0.4, heading1, heading2, heading3, heading4, point1, point2, point3));
    	addSequential(new autoClawClose());
    	addSequential(new gearRollerSetSpeed(0));
    	addSequential(new GyroTurnReverse(1,65));
    	addSequential(new EncReset());
    	addSequential(new DriveEncoderCurveSimpleReverseLeft(totalArca, 0.6, 0.4, heading1a, heading2a, heading3a, heading4a, point1a, point2a, point3a));
