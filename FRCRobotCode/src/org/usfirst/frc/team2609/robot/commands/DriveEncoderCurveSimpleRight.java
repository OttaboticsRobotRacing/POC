...
public class DriveEncoderCurveSimpleRight extends Command {
	SimPID drivePIDLeft;
	...
	public DriveEncoderCurveSimpleRight(double driveTarget, double drivePower, double gyroMax, double driveHeading1, double driveHeading2, double driveHeading3, double driveHeading4, double curvePoint1, double curvePoint2, double curvePoint3) {
    ...
    protected void execute() {
    	...
    	Robot.drivetrain.driveStraightRight(RobotMap.driveTalonLeft1.getPosition(), RobotMap.driveTalonRight1.getPosition(), gyroYaw, drivePIDLeft, drivePIDRight, steeringPID);	
    }
